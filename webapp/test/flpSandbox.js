					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ButterflyCollection",
									"targetURL": "#snokproject-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"snokproject-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=snok.project",
									"url": sap.ui.require.toUrl("snok/project")
								}
							}
						}
					}
